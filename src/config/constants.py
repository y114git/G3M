...
THEMES = {'default': {'name': 'G3M', 'background': 'images/background.png', 'font_family': 'Determination Sans Rus', 'font_size_main': 16, 'font_size_small': 12, 'colors': {'main_fg': '#282828', 'top_level_fg': '#282828', 'button': '#222222', 'button_hover': '#616b78', 'button_text': '#e8e9eb', 'border': '#039d5b', 'text': '#e8e9eb', 'secondary_text': '#6de985'}}}
