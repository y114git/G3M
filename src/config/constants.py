...
SLOT_ID_PIZZA_TOWER = -40
SLOT_ID_SUGARY_SPIRE = -50
SLOT_ID_MENU = 0
SLOT_ID_CHAPTER_1 = 1
SLOT_ID_CHAPTER_2 = 2
SLOT_ID_CHAPTER_3 = 3
...
GAMEBANANA_SUPPORTED_TOOL_IDS = (GAMEBANANA_TOOL_ID_DELTAHUB, GAMEBANANA_TOOL_ID_DELTAMOD)
GAMEBANANA_PER_PAGE = 20
GAMEBANANA_MAX_PAGES = 100
