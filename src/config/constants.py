...
GAME_PROCESS_NAMES = ['DELTARUNE.exe', 'DELTARUNE', 'UNDERTALE.exe', 'UNDERTALE', 'Undertale Yellow.exe', 'Undertale Yellow', 'PizzaTower.exe', 'PizzaTower', 'runner']
...
GAMEBANANA_GAME_IDS = {'deltarune': 6755, 'undertale': 5506, 'undertaleyellow': 19606, 'pizzatower': 7692}
GAMEBANANA_TOOL_ID_DELTAMOD = 20575
GAMEBANANA_TOOL_ID_DELTAHUB = 20615
GAMEBANANA_TOOL_ID_PIZZAOVEN = 12625
GAMEBANANA_SUPPORTED_TOOL_IDS = (GAMEBANANA_TOOL_ID_DELTAHUB, GAMEBANANA_TOOL_ID_DELTAMOD, GAMEBANANA_TOOL_ID_PIZZAOVEN)
GAMEBANANA_PER_PAGE = 20
GAMEBANANA_MAX_PAGES = 100
GAME_EXECUTABLES = {'deltarune': {'windows': ('DELTARUNE.exe', 'DELTARUNE'), 'linux': ('DELTARUNE', 'DELTARUNE.exe'), 'mac': ('DELTARUNE.app', 'DELTARUNEdemo.app')}, 'undertale': {'windows': ('UNDERTALE.exe', 'UNDERTALE'), 'linux': ('UNDERTALE', 'UNDERTALE.exe'), 'mac': ('UNDERTALE.app',)}, 'undertaleyellow': {'windows': ('Undertale Yellow.exe', 'Undertale Yellow', 'UNDERTALE.exe', 'UNDERTALE'), 'linux': ('Undertale Yellow', 'UNDERTALE', 'Undertale Yellow.exe', 'UNDERTALE.exe'), 'mac': ('UNDERTALE.app',)}, 'pizzatower': {'windows': ('PizzaTower.exe', 'PizzaTower'), 'linux': ('PizzaTower', 'PizzaTower.exe'), 'mac': ('PizzaTower.app',)}}
