...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QCheckBox, QLineEdit, QTextBrowser, QSizePolicy, QColorDialog
)
...
class SettingsViewBuilder:
    ...
    def _build_settings_menu_page(self) -> QWidget:
        ...
        settings_center_container.addWidget(beta_updates_checkbox, alignment=Qt.AlignmentFlag.AlignHCenter)

        fullscreen_checkbox = QCheckBox(tr('ui.fullscreen'))
        fullscreen_checkbox.setToolTip(tr('tooltips.fullscreen_tooltip'))
        settings_center_container.addWidget(fullscreen_checkbox, alignment=Qt.AlignmentFlag.AlignHCenter)
        ...
        settings_center_container.addWidget(hide_library_filters_checkbox, alignment=Qt.AlignmentFlag.AlignHCenter)
        ...
        customization_button = QPushButton(tr('ui.launcher_customization'))
