...
class SearchTabBuilder:
    ...
    def _create_filters_widget(self) -> QFrame:
        ...
        modgame_combo.addItem(tr('dropdowns.filter_deltarune'), 'deltarune')
        modgame_combo.addItem(tr('dropdowns.filter_deltarunedemo'), 'deltarunedemo')
        modgame_combo.addItem(tr('dropdowns.filter_undertale'), 'undertale')
        ...
        search_button.setToolTip(tr('tooltips.search'))
