"""Dialog for editing mod priority order."""
...
class ModPriorityDialog(QDialog):
    def __init__(
        self, mods_list: list[Any], chapter_id: int, app_state, parent=None
    ) -> None:
    ...
    def _apply_theme(self):
        ...
        self.instructions_label.setStyleSheet(
            f"color: {get_dialog_theme_values(self.app_state)['secondary_text']}; font-size: 11px;"
        )
