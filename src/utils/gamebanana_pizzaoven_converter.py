            ...
            for folder_name in os.listdir(self.mods_dir):
                ...
                try:
                    ...
                    if config_data.get('mod_key') == mod_key:
                        logger.info(f'GameBananaPizzaOvenConverter: Removing existing mod folder {folder_path} with mod_key {mod_key}')
    ...
    def _update_config_with_gb_metadata(self, mod_dir: str) -> str:
        ...
        try:
            ...
            if self.gamebanana_metadata.get('mod_id'):
                ...
                logger.info(f'GameBananaPizzaOvenConverter: Updated config - mod_key={expected_mod_key}, mod_dir={mod_dir}')
            ...
            logger.info(f"GameBananaPizzaOvenConverter: Updated config for GameBanana mod: mod_key={config_data.get('mod_key')}, mod_id={config_data.get('gamebanana_mod_id')}, mod_dir={mod_dir}")
            return mod_dir
