...
class GameVersionsManager(QObject):
    ...
    def _get_game_context(self, game_id: str):
        ...
        if not base_folder:
            ...
            return None
        protected = get_protected_exe_paths_with_config(base_folder, game_path, game_def, config)
        return game_def, game_path, base_folder, protected, config

    def create_version(self, game_id: str, version_name: str):
        ...
        def on_finished(success, error, size_bytes, file_count):
